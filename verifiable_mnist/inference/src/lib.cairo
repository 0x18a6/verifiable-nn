...
let node_7 = NNTrait::gemm(node__relu_relu_output_0, get_node_layer2_weight(), Option::Some(get_node_layer2_bias()), Option::Some(FP16x16 { mag: 65536, sign: false }), Option::Some(FP16x16 { mag: 65536, sign: false }), false, true);
